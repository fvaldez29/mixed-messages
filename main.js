...
const randomText = ['Happiness is not the absence of problems, it’s the ability to deal with them.', 
...
function getRandomWord(){
    const randomStr = randomText[Math.floor(Math.random() * randomText.length)]
    return randomStr
}

function showRandomText(){
    para.innerHTML = getRandomWord();

}


btn.addEventListener('click', showRandomText)
resetBtn.addEventListener('click', () => {para.innerHTML = ''})
